...
async def demo_inmemory_transport_with_filters():
    ...
    assert handler_calls.get("all_orders") == 2, "All orders handler should be called twice"
    assert handler_calls.get("requested_orders") == 1, "Requested orders handler should be called once"
