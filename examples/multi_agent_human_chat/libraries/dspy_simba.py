        ...
        with mlflow.start_run(run_name=run_name):
            ...
            if devset:
                ...
                if baseline_score is not None:
                    ...
                    relative_improvement = (improvement / max(baseline_score, 1e-9)) * 100
...
def load_optimized_react_agent(
    ...
    if os.path.exists(path):
        try:
            ...
            logger.error(f"Failed to load optimized agent: {e}. Creating unoptimized agent instead.")
    else:
