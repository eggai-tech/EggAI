...
from libraries.dspy_set_language_model import (
    TrackingLM,
...
class TestTrackingLM:
    ...
    @patch("libraries.dspy_set_language_model.dspy.LM.__init__")
    ...
    def test_truncate_prompt(self):
        ...
        with patch("libraries.dspy_set_language_model.dspy.LM.__init__", return_value=None):
    ...
    @patch("libraries.dspy_set_language_model.dspy")
    @patch("libraries.dspy_set_language_model.load_dotenv")
    def test_dspy_set_language_model_basic(self, mock_load_dotenv, mock_dspy):
        ...
        with patch("libraries.dspy_set_language_model.TrackingLM") as mock_tracking_lm:
            ...
            mock_dspy.configure.assert_called_once_with(lm=mock_lm_instance)
            mock_dspy.settings.configure.assert_called_once_with(track_usage=True)
            assert result is mock_lm_instance

    @patch("libraries.dspy_set_language_model.dspy")
    @patch("libraries.dspy_set_language_model.TrackingLM")
    def test_dspy_set_language_model_with_cache_control(self, mock_tracking_lm, mock_dspy):
    ...
    @patch("libraries.dspy_set_language_model.dspy")
    @patch("libraries.dspy_set_language_model.TrackingLM")
    def test_dspy_set_language_model_with_api_base(self, mock_tracking_lm, mock_dspy):
    ...
    @patch("libraries.dspy_set_language_model.dspy")
    @patch("libraries.dspy_set_language_model.TrackingLM") 
    def test_dspy_set_language_model_with_max_context(self, mock_tracking_lm, mock_dspy):
    ...
    @patch("libraries.dspy_set_language_model.dspy")
    @patch("libraries.logger.get_console_logger")
    @patch("libraries.dspy_set_language_model.TrackingLM")
    def test_dspy_set_language_model_logging(self, mock_tracking_lm, mock_get_logger, mock_dspy):
...
class TestDspySetLanguageModelExtras:
    ...
    @patch("libraries.dspy_set_language_model.dspy.LM.forward")
    ...
    @patch("libraries.dspy_set_language_model.dspy.LM.__call__")
    @patch("libraries.dspy_set_language_model.perf_counter")
