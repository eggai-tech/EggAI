...
class PricingCalculator:
    ...
    def calculate_cost(self, model_name: str, prompt_tokens: int, completion_tokens: int) -> Dict[str, Any]:
...
def calculate_request_cost(model_name: str, prompt_tokens: int, completion_tokens: int) -> Dict[str, Any]:
