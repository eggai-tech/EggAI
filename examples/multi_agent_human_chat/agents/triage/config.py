...
class Settings(BaseSettings):
    ...
    classifier_v3_model_name: str = Field(default="fewshot_classifier_n_200", env="CLASSIFIER_V3_MODEL_NAME")
    classifier_v3_model_version: str = Field(default="1", env="CLASSIFIER_V3_MODEL_VERSION")
