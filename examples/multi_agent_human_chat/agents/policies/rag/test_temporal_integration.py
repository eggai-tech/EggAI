...
async def main():
    ...
    logger.info(
        "This test demonstrates Temporal workflow execution for policy documentation queries"
    )
    logger.info(
        "You should see these workflows in the Temporal UI at http://localhost:8081"
    )
    logger.info("==============================================")
