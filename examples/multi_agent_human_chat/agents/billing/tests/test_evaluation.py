...
async def test_billing_response_evaluation():
    ...
    with setup_mlflow_tracking("billing_agent_evaluation_tests", 
        ...
        for i, case in enumerate(test_cases):
            ...
            agent_response = billing_optimized_dspy(chat_history=case["chat_history"])
            ...
            mlflow.log_metric(f"eval_precision_case_{i+1}", evaluation_result.precision_score)
