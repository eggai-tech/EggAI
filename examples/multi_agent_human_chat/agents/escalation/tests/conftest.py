...
def mock_language_model(monkeypatch):
    ...
    monkeypatch.setattr("libraries.dspy_set_language_model.dspy_set_language_model", lambda *args, **kwargs: mock_lm)
    return mock_lm
...
def mock_stream_channel(monkeypatch):
    ...
    monkeypatch.setattr("agents.escalation.agent.human_stream_channel.publish", mock_publish)
    return mock_publish
