...
- <a href="https://docs.egg-ai.com/examples/getting_started/">Examples</a>: Practical use cases showing how to use the SDK and integrate EggAI with leading AI frameworks.
- <a href="#demo-multi-agent-insurance-support-system">Demo</a>: A working multi-agent insurance support system showcasing the Meta Framework in action.
...
The EggAI Meta Framework powers a multi-agent insurance support system demo.
...
If you're new to EggAI, we recommend starting with the [Getting Started](https://docs.egg-ai.com/examples/getting_started/) example to learn the basics of agent definition, communication flows and async orchestration.

<table style="width: 100%;">
  <tbody>
    <tr>
      <td style="width: 15%;">
        <a href="https://docs.egg-ai.com/examples/getting_started/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/getting_started/"><strong>Getting Started</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/coordinator/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/coordinator/"><strong>Coordinator</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/websocket_gateway/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/websocket_gateway/"><strong>Websocket Gateway</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/dspy_react/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/dspy_react/"><strong>DSPy ReAct Agent</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/langchain_tool_calling/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/langchain_tool_calling/"><strong>LangChain Agent</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/litellm_agent/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/litellm_agent/"><strong>LiteLLM Agent</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/agent_evaluation_dspy/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/agent_evaluation_dspy/"><strong>Agent Evaluation & Optimization with DSPy</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/safe_agents_guardrails/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/safe_agents_guardrails/"><strong>Safe Agents with Guardrails AI</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/triage_agent/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/triage_agent/"><strong>Triage Agent</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/shared_context/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/shared_context/"><strong>Shared Context</strong></a><br/>
    ...
    <tr>
      <td>
        <a href="https://docs.egg-ai.com/examples/multi_agent_conversation/">
      ...
      <td>
        <a href="https://docs.egg-ai.com/examples/multi_agent_conversation/"><strong>Multi-Agent Conversation</strong></a><br/>
